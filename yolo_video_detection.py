...
def recognize_object(classesFilePath, modelConfigurationPath, modelWeightsPath, confThreshold=0.5, nmsThreshold=0.3, filter=False):
...
def main():
    classesFile = r"C:\Users\Dmytro\Desktop\VS Code\Object Recognition\models\yolo-tiny\labels.txt"
    modelConfiguration = r"C:\Users\Dmytro\Desktop\VS Code\Object Recognition\models\yolo-tiny\yolov3-tiny.cfg"
    modelWeights = r"C:\Users\Dmytro\Desktop\VS Code\Object Recognition\models\yolo-tiny\yolov3-tiny.weights"

    recognize_object(classesFile, modelConfiguration, modelWeights, filter=False)
